...
// reference: A0A8D11C45132D72, E25302F33B855909
// reference: A0A8D11C44D14745, E25302F33B855909
// reference: BA6D418D4AA16DC4, 7E88B52AEB89715B
// reference: 30AD36B51EC7EC24, 5554809D49BFB916
// program: 0000000000000000, 0000000000000000, E25302F33B855909
// program: 0000000000000000, 0000000000000000, 5554809D49BFB916
// reference: C24C709344D14745, E25302F33B855909
// shader: 8B30, CF1C3ACE40B05ED9
layout(location=0) in vec4 primary_color;
layout(location=1) in vec4 texcoord0;
layout(location=2) in vec4 texcoord12;
layout(location=3) in vec4 normquat;
...
specular_sum.rgb += (((lut_scale_d0 * d0_value) * light_src[1].specular_0) + ((lut_scale_d1 * d1_value) * light_src[1].specular_1)) * clamp_highlights * dist_value * 1.0;
...
vec4 next_combiner_buffer = tev_combiner_color;
vec4 last_tev_out = vec4(0);
vec3 color_output_0 = ByteRound(clamp(min((rounded_primary_color.rgb) + (primary_fragment_color.rgb), vec3(1)) * (texcolor0.rgb), vec3(0), vec3(1)));
float alpha_output_0 = ByteRound(clamp((texcolor0.a) * (rounded_primary_color.a), 0.0, 1.0));
last_tev_out = vec4(color_output_0, alpha_output_0);
last_tev_out = clamp(last_tev_out, vec4(0), vec4(1));
combiner_buffer = next_combiner_buffer;
...
bool Vfn0() {
tmp_reg13 = vs_pica.f[92].xxxz;
tmp_reg14 = vs_pica.f[92].xxxz;
tmp_reg13.xyz = (vs_in_reg0.xyzz).xyz;
tmp_reg14.x = dot_s(vs_pica.f[8], tmp_reg13);
tmp_reg14.y = dot_s(vs_pica.f[9], tmp_reg13);
tmp_reg14.z = dot_s(vs_pica.f[10], tmp_reg13);
tmp_reg13.x = dot_s(vs_pica.f[4], tmp_reg14);
tmp_reg13.y = dot_s(vs_pica.f[5], tmp_reg14);
tmp_reg13.z = dot_s(vs_pica.f[6], tmp_reg14);
tmp_reg8.x = dot_s(vs_pica.f[0], tmp_reg13);
tmp_reg8.y = dot_s(vs_pica.f[1], tmp_reg13);
tmp_reg8.z = dot_s(vs_pica.f[2], tmp_reg13);
tmp_reg8.w = dot_s(vs_pica.f[3], tmp_reg13);
vs_out_reg0 = tmp_reg8;
vs_out_reg5 = -tmp_reg13;
tmp_reg14.x = dot_3(vs_pica.f[8].xyz, vs_in_reg3.xyz);
tmp_reg14.y = dot_3(vs_pica.f[9].xyz, vs_in_reg3.xyz);
tmp_reg14.z = dot_3(vs_pica.f[10].xyz, vs_in_reg3.xyz);
...
tmp_reg15 = vs_in_reg4;
tmp_reg15 = tmp_reg15 + -vs_in_reg2;
tmp_reg15 = fma_s(tmp_reg15, vs_pica.f[17], vs_in_reg2);
vs_out_reg1 = mul_s(vs_pica.f[16], tmp_reg15);
tmp_reg0.x = dot_3(tmp_reg11.xyz, tmp_reg11.xyz);
tmp_reg0.x = rsq_s(tmp_reg0.x);
tmp_reg11.xyz = (mul_s(tmp_reg11.xyzz, tmp_reg0.xxxx)).xyz;
vs_out_reg2.x = dot_s(vs_pica.f[12], vs_in_reg1);
vs_out_reg2.y = dot_s(vs_pica.f[13], vs_in_reg1);
vs_out_reg2.z = dot_s(vs_pica.f[14], vs_in_reg1);
vs_out_reg2.w = dot_s(vs_pica.f[15], vs_in_reg1);
vs_out_reg3.x = dot_s(vs_pica.f[12], vs_in_reg1);
vs_out_reg3.y = dot_s(vs_pica.f[13], vs_in_reg1);
vs_out_reg3.z = dot_s(vs_pica.f[14], vs_in_reg1);
vs_out_reg3.w = dot_s(vs_pica.f[15], vs_in_reg1);
tmp_reg12 = vs_pica.f[92].xxxx;
bool_regs = equal(-vs_pica.f[92].zz, tmp_reg11.zz);
if (!bool_regs.x) {
tmp_reg9 = vs_pica.f[92].zzzz + tmp_reg11.zzzz;
tmp_reg9 = mul_s(vs_pica.f[92].yyyy, tmp_reg9);
tmp_reg9 = vec4(rsq_s(tmp_reg9.z));
tmp_reg10.xy = (mul_s(vs_pica.f[92].yyyy, tmp_reg11)).xy;
tmp_reg12.z = rcp_s(tmp_reg9.z);
tmp_reg12.xy = (mul_s(tmp_reg10.xyyy, tmp_reg9.xxxx)).xy;
} else {
tmp_reg12.x = (vs_pica.f[92].zzzz).x;
}
vs_out_reg4 = tmp_reg12;
return true;
}
// shader: 8B30, C0644E48B744F59F
layout(location=0) in vec4 primary_color;
layout(location=1) in vec4 texcoord0;
layout(location=2) in vec4 texcoord12;
layout(location=3) in vec4 normquat;
...
specular_sum.rgb += ((((lut_scale_d0 * d0_value) * light_src[0].specular_0) * geo_factor) + (((lut_scale_d1 * d1_value) * light_src[0].specular_1) * geo_factor)) * clamp_highlights * dist_value * 1.0;
diffuse_sum.rgb += lighting_global_ambient;
primary_fragment_color = clamp(diffuse_sum, vec4(0), vec4(1));
vec4 combiner_buffer = vec4(0);
vec4 next_combiner_buffer = tev_combiner_color;
...
// reference: F7A268FC297A1192, CF1C3ACE40B05ED9
// reference: 8F8359E2270A3B13, AAF5307041EDDB85
// reference: 35C9D193CDC23433, CE105229FCEFBF79
// reference: 1E910E9873AB01A9, 68DAB1CE28C27717
// reference: 4CB3B137E5247BC3, CF1C3ACE40B05ED9
// reference: C09B5DD42FEFA066, C0644E48B744F59F
// reference: 34928029EB545142, AAF5307041EDDB85
// reference: 2A68A62410B7C6A5, 31D45EE38969F77B
// program: 0000000000000000, 0000000000000000, CF1C3ACE40B05ED9
// program: 0000000000000000, 0000000000000000, AAF5307041EDDB85
// program: 0000000000000000, 0000000000000000, CE105229FCEFBF79
// program: 68DAB1CE28C27717, 0000000000000000, CE105229FCEFBF79
// program: 68DAB1CE28C27717, 0000000000000000, CF1C3ACE40B05ED9
// program: 0000000000000000, 0000000000000000, C0644E48B744F59F
// program: 0000000000000000, 0000000000000000, 31D45EE38969F77B
